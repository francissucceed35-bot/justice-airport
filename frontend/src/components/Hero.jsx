            ...
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              {isLoggedIn ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Link to="/signup" className="inline-block bg-blue-600 text-white font-semibold px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
                    Sign Up
                  </Link>
                  {/* UPDATED LOGIN BUTTON */}
                  <Link to="/login" className="inline-block bg-white text-gray-900 font-semibold px-4 py-2 rounded-md hover:bg-gray-200 transition-colors">
                    Login
                  </Link>
                </div>
              )}
