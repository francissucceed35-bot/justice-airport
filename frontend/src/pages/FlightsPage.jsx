    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center bg-blue-50 p-6 rounded-lg border border-blue-200">
          <h1 className='text-4xl font-extrabold text-gray-900'>Book a Flight</h1>
          <p className='mt-4 text-lg text-gray-600'>Fill out the form below to request your flight booking.</p>
        </div>
