...
const ShippingPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Error: Could not submit your request.');
      console.error(error);
    }
  };
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-gradient-to-br from-gray-100 to-blue-200 min-h-screen py-12">
